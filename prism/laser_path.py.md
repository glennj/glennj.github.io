...
ax.annotate('', xy=p2, xytext=(0, 0),
            arrowprops=dict(facecolor='blue', edgecolor='blue', shrink=0.05, width=5, headwidth=12))

# Arrow: Point 2 to Point 1 (Green)
ax.annotate('', xy=p1, xytext=p2,
            arrowprops=dict(facecolor='green', edgecolor='green', shrink=0.04, width=5, headwidth=12))

# Arrow: Point 1 to Point 3 (Red)
ax.annotate('', xy=p3, xytext=p1,
            arrowprops=dict(facecolor='red', edgecolor='red', shrink=0.025, width=5, headwidth=12))
...
ax.annotate('', xy=end_p3_arrow, xytext=p3,
            arrowprops=dict(facecolor='orange', edgecolor='orange', shrink=0, width=5, headwidth=12))

# now add the points and labels on top of the arrows
for p, label, color, label_coord in zip(points, labels, colors, label_coords):
    ax.plot(p[0], p[1], 'ro', markersize=15, markerfacecolor=color, markeredgecolor=color)
    ax.text(label_coord[0], label_coord[1], label, ha='center', fontsize=10, fontweight='bold')
